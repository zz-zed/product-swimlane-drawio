...
class EvidenceBaselineTests(unittest.TestCase):
    ...
    def test_old_input_current_patch_compares_without_waiving_pool_tampering(self):
        ...
        self.assertEqual(loaded.document.find_pool(after).get("data-tool-version"), "0.9.0")
    ...
    def test_version_normalization_preserves_invalid_or_wrong_input_stamp(self):
        ...
        for version in ("0.5.0", "0.5.1", "0.6.0", "0.6.1", "0.6.5", "0.7.0", "0.7.1", "0.8.0", "0.9.0"):
    ...
    def test_release_stamp_normalization_is_path_and_artifact_bound(self):
        for value in (None, 600, True, "unknown", "0.5.1", "0.6.1", "0.6.5", "0.7.0", "0.7.1", "0.8.0", "0.9.0"):
